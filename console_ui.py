...
def ui_menu(text_menu):
    """
    Функция реализующая пользовательский интерфейс в командной строке для произвольного меню.
...
def main_menu_for_tasks(task_name):
    """
    Функция реализующая пользовательский интерфейс в командной строке для главного меню.
